...
function sendToAnalytics(metric, options) {
    var _$exec, _document$querySelect, _self$___chunkMapping;

    // Scrape the intial component name from the DOM:
    var pageScript = [].slice.call((_$exec = /^\/component---(.+)\-(.+?)\-.{20}\.js$/.exec((_document$querySelect = document.querySelector("script[src^=\"/component---\"]")) === null || _document$querySelect === void 0 ? void 0 : _document$querySelect.getAttribute("src"))) !== null && _$exec !== void 0 ? _$exec : []).slice(1).join("-"); // Verify page name is correct:

    var pageName = "component---" + pageScript in ((_self$___chunkMapping = self.___chunkMapping) !== null && _self$___chunkMapping !== void 0 ? _self$___chunkMapping : {}) ? pageScript : null;
