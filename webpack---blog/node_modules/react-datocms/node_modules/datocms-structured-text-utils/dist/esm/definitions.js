...
export var allowedAttributes = (_b = {}, _b[blockquoteNodeType] = ['children', 'attribution'], _b[blockNodeType] = ['item'], _b[codeNodeType] = ['language', 'highlight', 'code'], _b[headingNodeType] = ['level', 'children'], _b[inlineItemNodeType] = ['item'], _b[itemLinkNodeType] = ['item', 'children', 'meta'], _b[linkNodeType] = ['url', 'children', 'meta'], _b[listItemNodeType] = ['children'], _b[listNodeType] = ['style', 'children'], _b[paragraphNodeType] = ['children'], _b[rootNodeType] = ['children'], _b[spanNodeType] = ['value', 'marks'], _b[thematicBreakNodeType] = [], _b);
export var allowedMarks = ['strong', 'code', 'emphasis', 'underline', 'strikethrough', 'highlight'];