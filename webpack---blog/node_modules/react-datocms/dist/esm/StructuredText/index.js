...
export var defaultAdapter = {
    ...
    renderFragment: function renderFragment(children, key) {
        return React.createElement(React.Fragment, {
            key: key
        }, children);
    },
    renderText: function renderText(text, key) {
        return text;
    }
};
...
export function StructuredText(_a) {
    var data = _a.data,
        renderInlineRecord = _a.renderInlineRecord,
        renderLinkToRecord = _a.renderLinkToRecord,
        renderBlock = _a.renderBlock,
        renderText = _a.renderText,
        renderNode = _a.renderNode,
        renderFragment = _a.renderFragment,
        customRules = _a.customRules,
        metaTransformer = _a.metaTransformer;
    var result = render({
    ...
    }, data, [renderRule(isInlineItem, function(_a) {
        var node = _a.node,
            key = _a.key;
        ...
        var item = data.links.find(function(item) {
        ...
        return appendKeyToValidElement(renderInlineRecord({
            record: item
        }), key);
        ...
        return appendKeyToValidElement(renderLinkToRecord({
            record: item,
            children: children,
            transformedMeta: node.meta ? (metaTransformer || defaultMetaTransformer)({
                node: node,
                meta: node.meta
            }) : null
        }), key);
        ...
        var item = data.blocks.find(function(item) {
            return item.id === node.item;
        });
        ...
        return appendKeyToValidElement(renderBlock({
            record: item
        }), key);
