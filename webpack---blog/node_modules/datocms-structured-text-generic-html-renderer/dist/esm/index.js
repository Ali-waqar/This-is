...
export function render(adapter, structuredTextOrNode, customRules, metaTransformer) {
    ...
    return genericRender(adapter, structuredTextOrNode, __spreadArrays(customRules, [renderRule(isRoot, function(_a) {
        ...
        var textWithNewlinesConvertedToBr = lines.length > 0 ? lines.slice(1).reduce(function(acc, line, index) {
        ...
        return marks.reduce(function(children, mark) {
            return renderNode(markToTagName(mark), {
                key: key
            }, children);
