/*!
	Salesforce Pardot's Engagement Tracker Javascript - 2022-04-04 14:11:12
...
piTracker(),
    function() {
        ...
        function r(e) {
            ...
            if ("false" === t || "" === t && "" === r) window.location = e;
            else {
                var i, a = getPardotUrl() + "/analytics?",
                    n = {
                ...
                var c = "analyticsCB" + (new Date).getTime();
                a += "&piClickCallback=" + c, pi[c] = function() {
                    window.location = e
                };
                var p = document.createElement("script");
                p.type = "text/javascript", p.src = a;
